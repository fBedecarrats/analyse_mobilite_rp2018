---
title: "Cas d'étude : mode de transport des trajets domicile travail (Recensement Général de la Population 2018)"
...
library(vroom) # Pour une lecture plus performante des csv volumineux
```
...
```{r}
flux <- vroom("Recensement/FD_MOBPRO_2018.zip",
...
A noter : les graphes sont composées de couches programmatiques. On peut ainsi Stocker le graphe dans une variable
...
# Construction de graphiques plus complexes
...
## Facettes pour obtenir des "petits multiples"
...
## Récupération de donnés spatiales
...
On voit qu'on a besoin de retravailer les seuils On teste une série d'algos automatiques pour la coloration
...
## Cartes plus élaborées avec {tmap}
...
# Carte de flux origines-destinations
...
> Exercice : modifier les fonds de carte avec un fond OSM ou ESRI, cf : https://r-tmap.github.io/tmap-book/layers.html#raster-layer
