...
prepare_freq <- function(frequencies, buffers, angle_diff = 20) {
...
frequenciesb %>%
  filter(angle_diff <= angle_diff | angle_diff >= 180 - angle_diff)
}
...
freq_in <- prepare_freq(frequencies = freqs, buffers = amgt_buff_10m)

freq_amgt <- summarise_freq(frequencies = freq_in,
                                  buffers = amgt_buff_10m,
                                  facilities = amgts)
