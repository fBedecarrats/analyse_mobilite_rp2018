...
# copy files from S3 
mc cp --recursive s3/fbedecarrats/diffusion/mobilites/Recensement/ $DATA_DIR
mc cp --recursive s3/fbedecarrats/diffusion/mobilites/Geovelo/ $DATA_DIR
mc cp --recursive s3/fbedecarrats/diffusion/mobilites/Documentation/ $DOC_DIR
